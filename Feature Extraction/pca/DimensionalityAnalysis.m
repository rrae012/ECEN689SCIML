...
if code == 1
    ...
    figure
    subtitle('Importance of each fetaure in PC1 - Subject 1')
    bar(categorical(FeatureNames),C(:,1))
    figure
    subtitle('Importance of each fetaure in PC2 - Subject 1')
    bar(categorical(FeatureNames),C(:,2))
    figure
    subtitle('Importance of each fetaure in PC3')
...
elseif code == 2
    ...
    figure
    subtitle('Importance of each fetaure in PC1 - Subject 2')
    bar(categorical(FeatureNames),C(:,1))
    figure
    subtitle('Importance of each fetaure in PC2 - Subject 2')
    bar(categorical(FeatureNames),C(:,2))
    figure
    subtitle('Importance of each fetaure in PC3')
    bar(categorical(FeatureNames),C(:,3))
...
elseif code == 0
    ...
    figure
    subtitle('Importance of each fetaure in PC1')
    bar(categorical(FeatureNames),C(:,1))
    figure
    subtitle('Importance of each fetaure in PC2')
    bar(categorical(FeatureNames),C(:,2))
